...
const RegisterQ13 = () => {
  ...
  const handleNext = () => {
    if (!eatingBehavior) {
      setError("Please select your eating behavior to continue.");
      return;
    }
    ...
    <BackgroundWrapper>
      <AuthCard>
        <div className="flex flex-col items-center">
          ...
          <p className="text-[#00260c] font-mulish mb-6 text-[13px]">Question 13 of 17</p>
          ...
          <div className="mt-6 w-full flex justify-center">
            <NextQ1Button onClick={handleNext} disabled={!eatingBehavior} />
          </div>
        </div>
      </AuthCard>
    </BackgroundWrapper>
